    ...
    const filterBoards = (filterType) => {
        ...
        switch (filterType) {
            ...
            case FILTER_ENUM.RECENT:
                ...
                break;
            case FILTER_ENUM.CELEBRATION:  case FILTER_ENUM.THANK_YOU: case FILTER_ENUM.INSPIRATION:
                filteredBoards = filteredBoards.filter(board => board.category === filterType);
                break;
            default:
                break;
        }
